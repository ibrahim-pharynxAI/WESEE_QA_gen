...
def split_md_into_chunks(content: str) -> List[str]:
    sections = []
    current_section = []
...
if __name__ == "__main__":
    # Ask user for a single markdown file path
    # path_txt = "test/test.txt"

    # md_file_path = path_txt.strip()
...
In  the  current  study,  he  provided  overall  guidance  in conceptualisation &amp; realisation of the experiment and finalisation of  the  manuscript.
    ...
    chunks = split_md_into_chunks(content)
